        ...
        <div class="col-md-6">
            <div class="box">
                <div class="box-header">
                    <div class="btn-group">
                        <a class="btn btn-primary btn-sm tree-6001e3b3d13a5-tree-tools" data-action="expand"
                           title="Развернуть">
                            <i class="fa fa-plus-square-o"></i>&nbsp;Развернуть
                        </a>
                        <a class="btn btn-primary btn-sm tree-6001e3b3d13a5-tree-tools" data-action="collapse"
                           title="Свернуть">
                            ...
                            @foreach($menu->parents as $taxonomy)
                                <li class="dd-item" data-id="{{ $taxonomy->id }}">
                                    ...
                                    @if($taxonomy->parents->count())
                                        @include('admin.menu.partials.list',['subcategories'=>$taxonomy->parents->sortBy('sort')])
                                    @endif
                                </li>
                            @endforeach
                        </ol>
